    ...
    if(PIR1bits.RCIF)
    {
        switch(caso)
        {
            ...
            case 3:
                ...
                {
                    case 49:
                        valor[pos_valor] = RCREG;
                        pos_valor = pos_valor + 1;
                        ...
                        if(pos_valor > 2)
                        {
                            ...
                            valor_dec[2] = traducir(valor[2]);
                            valor_dec[1] = 10*traducir(valor[1]);
                            valor_dec[0] = 100*traducir(valor[0]);

                            PORTA = sumar_vector(valor_dec);
